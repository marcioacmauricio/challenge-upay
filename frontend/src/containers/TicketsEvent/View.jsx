...
import { readTicketsEvent } from 'reducers/TicketsEvent/Actions'
					...
					<div className="col">
						<Card className="shadow">
							<CardHeader className="border-0">
								<MenuHeader getItem={this.getItem.bind(this)} Entity="TicketsEvent" ItemValue={ this.state.Item.id } ItemLabel={ this.state.Item.id } View="View" />	    				
							</CardHeader>
							<CardBody>
								<CardTitle><h2>Eventos</h2></CardTitle>
...
export default connect(mapStateToProps, {readTicketsEvent})(TicketsEventView);