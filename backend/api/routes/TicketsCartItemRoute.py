...
@jwtauth
class TicketsCartItemRoute(tornado.web.RequestHandler):
	def initialize(self):
		self.data = {}
	...
	def authorize(self, User):
		...
		self.Entity = self.DB.getEntity('TicketsCartItem')
	...
	def get(self, item_id = None ):
		Return = {}
		Columns = ['id', 'ordering', 'state', 'checked_out', 'checked_out_time', 'created_by', 'created_time', 'modified_by', 'modified_time', 'id_cart', 'id_event', 'amount', 'total']
